...
## 什么情况下使用HMC?    （Why do I need to use this module ?）
...
## 能够实现一些什么功能  （What functions can be achieved）
...
###  在 TypeScript 中使用    In TypeScript using the
...
- getAllWindows 获取所有窗口的信息  (不建议使用  **已弃用** 请用 getAllWindowsHandle 代替)
