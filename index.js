...
class hmc_win32 {
    ...
    setWindowMode(HWND, x, y, width, height) {
        ...
        if (!height)
            height = 0;
        return native.setWindowMode(this.ref.int(HWND), this.ref.int(x), this.ref.int(y), this.ref.int(width), this.ref.int(height));
    }
    /**
     * 判断注册表中是否有该键值
     * @param HKEY 根路径
    ...
    hasRegistrKey(HKEY, Path, key) {
        ...
        return native.hasRegistrKey(HKEY, this.ref.string(Path)
            .split(/[\\\/]+/g)
    ...
    getRegistrQword(HKEY, Path, key) {
        ...
        return native.getRegistrQword(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    getRegistrDword(HKEY, Path, key) {
        ...
        return native.getRegistrDword(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    getRegistrBuffValue(HKEY, Path, key) {
        ...
        return native.getRegistrBuffValue(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    enumRegistrKey(HKEY, Path) {
        ...
        let NatenumKey = native.enumRegistrKey(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"));
    ...
    getStringRegKey(HKEY, Path, key) {
        ...
        return native.getStringRegKey(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    getNumberRegKey(HKEY, Path, key) {
        ...
        return this.ref.int(native.getStringRegKey(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key)));
    }
    ...
    removeStringRegKey(HKEY, Path, key) {
        ...
        return native.removeStringRegKey(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    removeStringRegKeyWalk(HKEY, Path, key) {
        ...
        return native.removeStringRegKeyWalk(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]+/g)
            .join("\\"), this.ref.string(key));
    }
   ...
   */
    ...
    removeStringRegValue(HKEY, Path, key) {
        ...
        return native.removeStringRegValue(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]/g)
            .join("\\"), this.ref.string(key));
    }
    ...
    setRegistrKey(HKEY, Path, key, Value) {
        ...
        return native.setRegistrKey(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]/g)
    ...
    createPathRegistr(HKEY, Path) {
        hasregArgs(HKEY, Path, "createPathRegistr");
        return native.createPathRegistr(HKEY, this.ref
            .string(Path)
            .split(/[\\\/]/g)
            .join("\\"));
    }
     ...
     */
    alert(Message, Title) {
        return native.alert(Message, typeof Title != "string" ? getDefaultTitele() : Title);
    }
    /**
    ...
    confirm(Message, Title) {
        return native.confirm(Message, typeof Title != "string" ? getDefaultTitele() : Title);
    }
    /**
    ...
    MessageStop(Message, Title) {
        return native.MessageStop(Message, typeof Title != "string" ? getDefaultTitele() : Title);
    }
    /**
    ...
    MessageError(Message, Title) {
        return native.MessageError(Message, typeof Title != "string" ? getDefaultTitele() : Title);
    }
    /**
    ...
    */
    ...
    openApp(AppPath, Command, cwd, hide, UAC) {
        return native.openApp(this.ref.string(AppPath), this.ref.string(Array.isArray(Command)
    ...
    */
    ...
    SetWindowInTaskbarVisible(Handle, Visible) {
        return native.SetWindowInTaskbarVisible(this.ref.int(Handle), this.ref.bool(Visible));
    }
    /**
     * 获取句柄对应的进程id
     * @param Handle 句柄
    ...
    lookHandleSetTitle(Handle, title) {
        return native.lookHandleSetTitle(this.ref.int(Handle), this.ref.string(title));
    }
    /**
    ...
    lookHandleShowWindow(Handle, SetShowType) {
        return native.lookHandleShowWindow(this.ref.int(Handle), this.ref.int(typeof SetShowType == "number" ? this.ref.int(SetShowType) : 5));
    }
    /**
     * 设置窗口不透明度 0-255
     * @param Handle
    ...
    setHandleTransparent(Handle, Transparent) {
        return native.setHandleTransparent(this.ref.int(Handle), this.ref.int(Transparent || 255));
    }
    /**
     * 设置窗口是否支持响应事件(鼠标键盘点击)
     * @param Handle
    ...
    setWindowEnabled(Handle, Enabled) {
        return native.setWindowEnabled(this.ref.int(Handle), this.ref.bool(Enabled));
    }
    /**
     * 设置窗口焦点
     * @param Handle
    ...
    messageBox(message, title, UINT_String) {
        return native.messageBox(this.ref.string(message), this.ref.string(title), this.ref.string(UINT_String));
    }
