...
namespace hmc_string_util
{
    ...
    LPWSTR string_to_lpstr(wstring input);
    LPCSTR string_to_lpstr(string input);
    LPWSTR string_to_lpstr(wstring input, _In_ size_t psize);
    LPCSTR string_to_lpstr(string input, _In_ size_t &psize);
    wstring lpstr_to_string(LPWSTR szClip, int nBufSize, bool earlyTruncation = false);
    string lpstr_to_string(LPSTR szClip, int nBufSize, bool earlyTruncation = false);
    wstring lpstr_to_string(LPWSTR input);
    string lpstr_to_string(LPSTR input);
};
