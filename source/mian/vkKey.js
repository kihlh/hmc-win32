...
exports.KeyboardcodeEmenList = exports.KeyboardVKcodeEmenList = exports.vkKey = exports.KeyboardVKcodeComparisonEmenList = exports.KeyboardcodeComparisonTable = void 0;
exports.KeyboardcodeComparisonTable = new Map();
exports.KeyboardVKcodeComparisonEmenList = [
    ["Escape", null, 27, 0x1b, ["esc"]],
    ["F1", null, 112, 0x70],
];
function installKeyboardcodeComparisonTable() {
    exports.KeyboardcodeEmenList.forEach(function (value, key) {
        if (value.length == 5) {
            if (value[4])
                for (let index = 0; index < value[4].length; index++) {
                    const of_value = value[4][index];
                    exports.KeyboardcodeComparisonTable.set(of_value.toUpperCase(), key);
                }
        }
        if (typeof value[0] == "string") {
            exports.KeyboardcodeComparisonTable.set(value[0].toUpperCase(), key);
        }
        if (typeof value[1] == "string") {
            exports.KeyboardcodeComparisonTable.set(value[1].toUpperCase(), key);
        }
    });
}
/**
...
function vkKey(key) {
    ...
    if (typeof key == "string") {
        key = key.toUpperCase();
        if (!exports.KeyboardcodeComparisonTable.size)
            installKeyboardcodeComparisonTable();
        if (exports.KeyboardcodeComparisonTable === null || exports.KeyboardcodeComparisonTable === void 0 ? void 0 : exports.KeyboardcodeComparisonTable.has(key)) {
            return exports.KeyboardcodeComparisonTable.get(key) || null;
        }
    }
    return null;
}
exports.vkKey = vkKey;
exports.KeyboardVKcodeEmenList = [
...
exports.KeyboardcodeEmenList = (() => {
    let data = new Map();
    for (let index = 0; index < exports.KeyboardVKcodeEmenList.length; index++) {
        const [VK_key, VK_code, VK_keyCode, VK_VirtualKey, VK_Nickname] = exports.KeyboardVKcodeEmenList[index];
        data.set(VK_VirtualKey, exports.KeyboardVKcodeEmenList[index]);
    }
    return data;
})();
