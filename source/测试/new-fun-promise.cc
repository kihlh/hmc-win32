...
#define NEW_PROMISE_FUNCTION_DEFAULT_FUN {\
    ...
    std::any PromiseWorkFunc(std::vector<any> arguments_list);\
...
napi_value Init(napi_env env, napi_value exports)
{
    ...
    fu_New_Promise_class::exports(env, exports, "startThread");
    fu_New_Promise_class::exportsSync(env, exports, "startThreadSync");
